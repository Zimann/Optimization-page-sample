...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        ...
        //Z- calculated the new width based on one single element instead of recalculating the same values for every selected pizza
...
function updatePositions() {
    ...
    //Z- moved the calculation into a variable, avoiding the same repeated operation in the for loop
    var topScrollCalc = document.body.scrollTop / 1250;

    for (var i = 0; i < items.length; i++) {
        var phase = Math.sin(topScrollCalc + (i % 5)) * 100;
